// Sections Loader for Safari Match website
...
async function loadAllSections() {
  const sections = [
    { id: "hero-section-placeholder", file: "parts/hero-section.html" },
    {
      id: "how-to-play-section-placeholder",
      file: "parts/how-to-play-section.html",
    },
    { id: "game-section-placeholder", file: "parts/game-section.html" },
    { id: "features-section-placeholder", file: "parts/features-section.html" },
    {
      id: "field-description-section-placeholder",
      file: "parts/field-description-section.html",
    },
    {
      id: "reviews-section-placeholder",
      file: "parts/reviews-section.html",
    },
  ];
  ...
  for (const section of sections) {
    try {
      ...
      if (section.file === "parts/reviews-section.html") {
