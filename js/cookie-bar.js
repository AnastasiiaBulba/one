// Cookie Bar functionality for Safari Match website
...
function acceptCookies() {
  ...
  localStorage.setItem("safari-match-cookies-accepted", "true");
  localStorage.setItem("safari-match-cookies-date", new Date().toISOString());
...
function trackCookieAcceptance() {
  ...
  if (typeof gtag !== "undefined") {
    gtag("event", "cookie_acceptance", {
      ...
      event_label: "safari_match_cookies",
    });
  }
}
...
function areCookiesAccepted() {
  return localStorage.getItem("safari-match-cookies-accepted") === "true";
}

// Function to get cookie acceptance date
function getCookieAcceptanceDate() {
  const dateString = localStorage.getItem("safari-match-cookies-date");
  return dateString ? new Date(dateString) : null;
}

// Function to reset cookie acceptance (for testing purposes)
function resetCookieAcceptance() {
  localStorage.removeItem("safari-match-cookies-accepted");
  localStorage.removeItem("safari-match-cookies-date");
  localStorage.removeItem("safari-match-cookie-analytics");
...
window.addEventListener("storage", function (e) {
  if (e.key === "safari-match-cookies-accepted") {
    const cookieBar = document.getElementById("cookie-bar");
